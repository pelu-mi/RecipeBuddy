  ...
  if (!userData?.username) {
    return (
      <h4 style={{
        ...
        margin: "0 auto",
        minHeight: "77vh",
        background: "linear-gradient(white, #e8c38c)",
        textAlign: "center",
      }}>
  ...
  return (
    <div className="recipe-results-container">
      <Row className="recipe-container">
        <h4 className="viewing-txt">
          {userData.savedRecipes.length
            ? `You have saved ${userData.savedRecipes.length} ${
      ...
      /> */}
      {/* Uncomment this to always show the cart on the profile page <Cart /> */}
    </div>
  );
};
